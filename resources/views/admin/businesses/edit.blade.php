...
<main class="main-content" style="margin-top: 76px;">
    <div class="container-fluid p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">Edit Business Account</h1>
                <p class="text-muted">Update business account information</p>
            </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white">
                        <h5 class="card-title mb-0">
                            <i class="bi bi-pencil me-2"></i>Edit Business: {{ $business->business_name }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.businesses.update', $business) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="username" 
                                               name="username" 
                                               value="{{ old('username', $business->username) }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="border rounded p-3 text-center">
                                            <img id="logo-preview" src="{{ $business->logo_url }}" 
                                                 alt="Current Logo" 
                                                 class="img-fluid" 
                                                 style="max-height: 100px; max-width: 200px;">
                                            <div class="text-muted small mt-2">Current business logo</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" 
                                               ...
                                               id="expires_at" 
                                               name="expires_at" 
                                               value="{{ old('expires_at', $business->expires_at ? $business->expires_at->format('Y-m-d') : '') }}">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-circle me-2"></i>Update Business Account
                                </button>
                            </div>
                        </form>
                    </div>
